...
/**
 * Retrieve a list of a channel's broadcasts, using OAuth 2.0 to authorize API requests.
 *
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (LiveBroadcast broadcast : returnedList) {
                ...
                System.out.println("  - EmbedHTML: " + broadcast.getContentDetails().getMonitorStream().getEmbedHtml());
                System.out.println("\n-------------------------------------------------------------\n");
            }
